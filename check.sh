...
Media_Cookie=$(curl -s --retry 3 --max-time 10 "https://raw.githubusercontent.com/tiktokdaoqingcheng/RegionRestrictionCheck/main/cookies")
IATACode=$(curl -s --retry 3 --max-time 10 "https://raw.githubusercontent.com/tiktokdaoqingcheng/RegionRestrictionCheck/main/reference/IATACode.txt")
IATACode2=$(curl -s --retry 3 --max-time 10 "https://raw.githubusercontent.com/tiktokdaoqingcheng/RegionRestrictionCheck/main/reference/IATACode2.txt" 2>&1)
...
function MediaUnlockTest_NetflixCDN() {
    ...
    #local IATACode2=$(curl -s --retry 3 --max-time 10 "https://raw.githubusercontent.com/tiktokdaoqingcheng/RegionRestrictionCheck/main/reference/IATACode2.txt" 2>&1)
...
function ScriptTitle() {
    if [[ "$language" == "e" ]]; then
        ...
        echo -e "${Font_Green}Github Modify Fork:${Font_Suffix} ${Font_Yellow} https://github.com/tiktokdaoqingcheng/RegionRestrictionCheck ${Font_Suffix}"
        ...
        echo -e "${Font_Green}改版地址${Font_Suffix} ${Font_Yellow}https://github.com/tiktokdaoqingcheng/RegionRestrictionCheck ${Font_Suffix}"
...
function Start() {
	  echo -e ""
    #bash <(curl -s https://raw.githubusercontent.com/tiktokdaoqingcheng/RegionRestrictionCheck/main/reference/AD/AD${ADN})
    bash <(curl -s https://raw.githubusercontent.com/tiktokdaoqingcheng/RegionRestrictionCheck/main/reference/AD/ADDV)
	  echo -e ""
    bash <(curl -s https://raw.githubusercontent.com/tiktokdaoqingcheng/RegionRestrictionCheck/main/reference/AD/AD2)
	  echo -e ""
    bash <(curl -s https://raw.githubusercontent.com/tiktokdaoqingcheng/RegionRestrictionCheck/main/reference/AD/AD)
	  echo -e ""
    if [[ "$language" == "e" ]]; then
